...
class Autoencoder(Model):
    def __init__(self, latent_dim):
        ...
        self.decoder = tf.keras.Sequential([
            layers.Dense(224*224*2*2, activation='sigmoid'),
...
if __name__ == "__main__":
    ...
    '''
    # SOURCE = "C:/data/in"
    SOURCE = 'D:/Data/in/36cc'
    TARGET = 'D:/Data/out/36cc'
    FIG_SIZE = (20, 20)
    ...
    2. Load training images
    '''
    data_path = 'D:/Data/out/36cc'  # 'D:/Data/36_57'
    x_train = create_training_data(data_path)

    data_path = "D:/Data/out/36cc/test"    # "D:/Data/36_57_test"
    x_test = create_training_data(data_path)

    '''
    3. Build autoencoder 
    '''
    autoencoder = Autoencoder(latent_dim=64*2)  # 64*3
