...
python코드 GPU 실행
    https://www.tensorflow.org/install/pip
        ...
        https://pypi.org/
            ...
            (venv) C:\workspace\autoencoder>pip install jupyter
            (venv) C:\workspace\autoencoder>pip install opencv-python
            (venv) C:\workspace\autoencoder>pip install librosa
